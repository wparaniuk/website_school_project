...
<center><? include('menu.php'); ?><? include('../base.php'); ?></center>
<? $request=mysql_query("DELETE FROM articles WHERE id='$_GET[id]'"); echo ('<center>Artykuł został skasowany</center>'); ?>
<center><table width=900 border="0"><tr bgcolor=#b9de2e><td width="400"><b>ID - TYTUŁ</b></td><td><b>Edytuj</b></td><td><b>Kasuj</b></td></tr>
<?
