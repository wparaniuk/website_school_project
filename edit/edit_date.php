...
<div id="popup_date" class="overlay">
	<div class="popup">
		<a class="close" href="#">&times;</a>
		<div class="popupcontent">
			<div class="select-style w1 left">
				<select class="orange left" name="day">
			...
			<div class="select-style w2 left">
				<select class="orange left" name="month">
					<option value="Styczen">Styczen</option>
			...
			<div class="select-style w3 left">
				<select class="orange left" name="year">
			...
			<input class="popupsave orange right titilium" type="submit" value="Zapisz" name="datebtn"><br>
		</div>
	</div>
</div>
<form>